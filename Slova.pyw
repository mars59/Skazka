...
#-------------------------------------------------------------------------------
# Name:        Slova
# Purpose: Научиться строить слова и предложения с помощью клавиатуры
#
...
window.setWindowTitle("Создаем слова и предложения на Буквице")
...
labTitle = QtWidgets.QLabel("<center>Буквы азбуки Буквица (клавиатура)")
pixmap = QPixmap(азбука.файл_c_изображением)
lblPicture = QtWidgets.QLabel()
lblPicture.setPixmap(pixmap)
lblGuide = QtWidgets.QLabel("<center>Созданный текст.")
